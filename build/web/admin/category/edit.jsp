<%-- 
    Document   : edit
    Created on : May 10, 2023, 1:26:14 PM
    Author     : Dell
--%>
                            ...
                            <div class="card-body">
                                <form action="EditCategoryServlet" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="image" value="${category.image}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" >
                                        <img class="mt-2" width="150" height="100" src="${category.image}"/>
                                        <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                                    </div>
